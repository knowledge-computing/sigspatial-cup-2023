...
def main():
    ...
    for image in data['images']:
        ...
        if invalid_images.get(image_name) is None:
    ...
    with open(os.path.join(data_path, f'train_pos.txt'), 'w') as f:
        for image in train_pos_images:
            f.writelines(image + '\n')
        
    with open(os.path.join(data_path, f'train_neg.txt'), 'w') as f:
        for image in train_neg_images:
            f.writelines(image + '\n')
    
    with open(os.path.join(data_path, f'train_hard_neg.txt'), 'w') as f:
